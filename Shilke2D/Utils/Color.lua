...
--]]
function Color.rgba2hex(r,g,b,a)
	if a then 
...
Color object or as (0,255) rgb or rgba values or as hex string or int32 color. 
...
@param da[opt=255] (0,1) default alpha return value.
@return _r (0,1)
@return _g (0,1)
@return _b (0,1)
@return _a (0,1)
...
function Color._paramConversion(r,g,b,a,da)
	...
	elseif t == 'number' then
		if g then
			...
			--if no alpha neither default alpha value are provided, default on full alpha
			_a = _a or 1
		else
			_r, _g, _b, _a = Color.int2rgba(r)
			_r = _r * INV_255
			_g = _g * INV_255
			_b = _b * INV_255
			_a = _a * INV_255			
